...
import quanteam.sg.kata.bankaccount.adapters.web.AccountInterceptorController;
...
@ContextConfiguration(classes = {AccountController.class, AccountInterceptorController.class})
